        ...
        <div class="ta-result-truck">
          <div class="ta-result-truck-header">
            ...
            <div class="ta-truck-meta">
              <span><i class="fa-solid fa-weight-hanging" style="margin-right:4px; font-size:0.7rem;"></i><span class="weight-val">${(truck.currentWeight / 1000).toFixed(1)}</span> / ${(truck.capacity / 1000).toFixed(0)}T = ${util}%
                <span class="ta-utilization-bar">
                  <span class="ta-utilization-fill" style="width:${util}%; background:${barColor};"></span>
                </span>
              </span>
              <span><i class="fa-solid fa-cube" style="margin-right:4px; font-size:0.7rem;"></i><span class="weight-val">${truck.currentCbm.toFixed(1)}</span> / ${truck.cbmCapacity.toFixed(1)} CBM = ${truck.cbmUtilization}%
                <span class="ta-utilization-bar">
